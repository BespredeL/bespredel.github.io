const translations = {
    ru: {
        ...
        featured_label: "Избранный проект",
        featured_text: "Open-source система компьютерного зрения: детекция, трекинг и подсчёт объектов с камер в реальном времени.",
        featured_cta: "Открыть сайт →",
        github_title: "GitHub",
    ...
    en: {
        ...
        featured_text: "Open-source computer vision system: real-time object detection, tracking, and counting from cameras.",
        featured_cta: "Open site →",
        github_title: "GitHub",
